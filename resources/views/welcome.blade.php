<x-app-layout>
    ...
    <section class="bg-cover" style="background-image: url({{asset('img/home/people-2557399_1920.jpg')}})">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-36">
            <div class="w-full md:w-3/4 lg:w-1/2">
                <h1 class="text-white font-fold text-4xl">Domina la tecnologia web con los diferentes programas</h1>
                <p class="text-white text-lg mt-2">En la unidad de postgrado encontraras diferentes programas para superarte</p>
    ...
    <section class="mt-24">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-8">
            <article>
                ...
                <header class="mt-2">
                    <h1 class="tex-center text-xl text-gray-700" >Cursos y proyectos</h1>
                </header>
    ...
    <section class="mt-24 bg-gray-700 py-12">
        <h1 class="tex-center text-white">No sabes que programa llevar?</h1>
    ...
    <section class="my-24">
        ...
        <p class=" text-center text-gray-500 text-sm mb-6">Trabajo dura para ser el mejor de las ramas</p>
