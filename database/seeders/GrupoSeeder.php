...
class GrupoSeeder extends Seeder
{
    ...
    public function run()
    {
        Grupo::create(['docente_id'=>1,'programa_id'=>1,'modulo_id'=>1]);
        Grupo::create(['docente_id'=>1,'programa_id'=>1,'modulo_id'=>2]);
        Grupo::create(['docente_id'=>1,'programa_id'=>1,'modulo_id'=>3]);
        Grupo::create(['docente_id'=>1,'programa_id'=>1,'modulo_id'=>4]);
    /*
